...
public class ListDataFavourite extends AppCompatActivity {
    ...
    List<ModelLigaRealm> DataArrayList; //kit add kan ke adapter
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (DataArrayList.size() == 0){
            ...
            adapter = new DataAdapterFavourite((ArrayList<ModelLigaRealm>) DataArrayList, new DataAdapterFavourite.Callback() {
                @Override
